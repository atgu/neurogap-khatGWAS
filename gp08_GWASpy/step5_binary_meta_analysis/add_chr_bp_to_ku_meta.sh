...
# This should work if you just indicate both files as well
# this is a dummy example also I made below, basically you want to just put whatever your output from the meta analysis step was here
process_meta_file se_metal_ku_all_sites1.tbl ku_se_meta.txt
