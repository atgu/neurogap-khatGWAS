...
OUTPUT_DIR="${WORKDIR}/output/Nas0_MAF1e-2_corrected"
LOGDIR="${WORKDIR}/logs"
COMPLETION_FILE="${WORKDIR}/maf1e-2_site_completion.txt"

# declaring which sites and .sh files to run
declare -a SITES=("AAU" "KEMRI" "Uganda" "Moi")
declare -a SCRIPTS=("aau_run_polmm.sh" "kemri_run_polmm.sh" "uganda_run_polmm.sh" "moi_run_polmm.sh")
